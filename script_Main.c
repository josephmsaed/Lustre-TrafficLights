...
void script_Car_TL_step(_boolean button,_integer id,_boolean *red,_boolean *green,_boolean *yellow,script_Car_TL_ctx_type* ctx){   _boolean _split_15;
   _boolean _split_14;
   _boolean _split_13;
   _boolean _split_12;
   _boolean _split_11;
...
void script_Main_ctx_reset(script_Main_ctx_type* ctx){
  int _i;
    ...
    script_Car_TL_ctx_reset(&ctx->script_Car_TL_ctx_tab[1]);
    Lustre_pre_ctx_reset(&ctx->Lustre_pre_ctx_tab[0]);
    Lustre_pre_ctx_reset(&ctx->Lustre_pre_ctx_tab[1]);
}
...
void script_Main_step(_boolean NS_button,_boolean EW_button,_integer *NS_Cars,_integer *EW_Cars,script_Main_ctx_type* ctx){   _integer _split_21;
   _integer _split_20;
   _integer _split_19;
   _integer _split_18;
   _integer _split_17;
  ...
  id0 = 0;
  id1 = 1;
  script_Car_TL_step(NS_button,id0,&NS_R,&NS_G,&NS_Y,&ctx->script_Car_TL_ctx_tab[0]); 
  script_Car_TL_step(EW_button,id1,&EW_R,&EW_G,&EW_Y,&ctx->script_Car_TL_ctx_tab[1]); 
  ...
  Lustre_pre_set(*NS_Cars,&ctx->Lustre_pre_ctx_tab[0]); 
  Lustre_pre_get(&_split_19,&ctx->Lustre_pre_ctx_tab[1]); 
   if (EW_G == _true) {
     _split_20 = 2;
   } else {
     _split_20 = _split_19;
  ...
  Lustre_pre_set(*EW_Cars,&ctx->Lustre_pre_ctx_tab[1]); 
