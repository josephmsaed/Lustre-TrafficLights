...
void script_Pedestrian_TL_step(_boolean button,_boolean *red,_boolean *green,script_Pedestrian_TL_ctx_type* ctx){   _boolean _split_12;
   _boolean _split_11;
   _integer _split_10;
   _integer _split_9;
   _integer _split_8;
  ...
  Lustre_pre_2_get(&_split_1,&ctx->Lustre_pre_2_ctx_tab[0]); 
  Lustre_pre_get(&_split_2,&ctx->Lustre_pre_ctx_tab[2]); 
  _split_3 = _split_2 > 0;
  Lustre_pre_get(&_split_4,&ctx->Lustre_pre_ctx_tab[1]); 
  _split_5 = _split_4 <= 5;
  _split_6 = _split_3 & _split_5;
  _split_7 = _split_1 | _split_6;
  ...
  Lustre_arrow_step(0,_split_10,&counter,&ctx->Lustre_arrow_ctx_tab[0]); 
  ...
  _split_11 = counter < 2;
  Lustre_arrow_2_step(_true,_split_11,red,&ctx->Lustre_arrow_2_ctx_tab[0]); 
  _split_12 = counter >= 2;
  Lustre_arrow_2_step(_false,_split_12,green,&ctx->Lustre_arrow_2_ctx_tab[1]); 
